  ...
  <div class="content">\
      <div id="login-form" class="form-horizontal register-screen" >\
        <div class="control-group">\
          <div class="user_name">\
            <input type="text" id="name" name="name"  class="width_90p input-xlarge" placeholder="Enter your user name *" value="">\
          </div>\
          <div class="user_password">\
            <input type="password" id="password" name="password"  class="width_90p input-xlarge" placeholder="Password *" value="">\
          </div>\
