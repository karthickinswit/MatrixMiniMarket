                        ...
                        <div class="scroll_ele">\
                            <ul class="products list-group">\
                                {{#categories}}\
                                    ...
                                    {{#smartSpot}}"#audits/{{mId}}/category/{{category_id}}/brands"{{/smartSpot}}\
                            ...
                            <button class="audit-btn complete_audit btn btn-success" disabled="disabled" href={{mId}}>Mark as completed</button>\
